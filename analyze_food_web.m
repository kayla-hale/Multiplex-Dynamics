% This script analyzes outputs of Rewards Only Food Web (FW) simulations.
% Specifically, it calculates DIVERSITY, PERSISTENCE, ABUNDANCE, and final
% FLOWS (including consumption, production, and metabolic rate) for the
% final community and each guild of species at the end of simulations. 
% It generates a single file: Results_RO_FW_Flows.txt with column headings 
...
for i = 1:num_simulations
    ...
    [total_production, total_consumption_on,...
        total_consumption_by, total_metabolic_loss] = ...
        calc_food_web_flows(this_network, these_metabolics, this_sample,...
        final_biomasses);
...
% save results
writetable(results_table,'Results_RO_FW_Flows.txt')
