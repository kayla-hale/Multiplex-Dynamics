...
%used for control simulations where plants' biomass (B) includes rewards, 
%so, to match the original simulations, the sum of all species' rewards 
%biomass from the original simulations is subtracted off the competition 
%calculation. Using sum_R = 0 or sum_R = [] makes the 'community-wide'
%calculation identical to the 'community-wide_control' calculation. 
%   competition is a double bounded between 0 and 1 equal to the realized
